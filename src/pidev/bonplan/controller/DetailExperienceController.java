...
import pidev.bonplan.entites.avis;
import pidev.bonplan.entites.offre_experience;
import pidev.bonplan.services.AvisExperience;
...
public class DetailExperienceController implements Initializable {
    ...
    public void initData(offre_experience o) {
        ...
        imgdetail.setImage(new Image("file:C:\\xampp\\htdocs\\PhpstormProjects\\Pidev3\\web\\uploads\\images\\" + o.getUrl_image()));
        ...
        for (int i = 1; i < list.size(); i++) {
            ...
            ImageView img = new ImageView(new Image("file:C:\\xampp\\htdocs\\PhpstormProjects\\Pidev3\\web\\uploads\\images\\" + (list.get(i).getImageuser())));
            img.setFitWidth(50);
            img.setFitHeight(50);
        ...
        for (avis aa : list) {
            ...
            images[i] = new Image("file:C:\\xampp\\htdocs\\PhpstormProjects\\Pidev3\\web\\uploads\\images\\" + aa.getUrl_image());
            i++;
